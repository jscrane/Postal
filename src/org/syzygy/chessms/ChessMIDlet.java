...
abstract class ChessMIDlet
	extends PauseableMIDlet
{
	protected ChessMIDlet()
	{
...
//		main.addCommand(export);
	...
	private final StateChangeListener stateListener = new StateChangeListener() {
	...
	protected final Command ok = new Command("OK", Command.SCREEN, 1);
	protected final Command cancel = new Command("Cancel", Command.SCREEN, 1);
