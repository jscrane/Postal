	...
	extends Transport
{
	...
	private void send(MessageConnection conn, String message, String number)
		throws IOException
	{
	...
	protected synchronized Connection doListen()
		throws IOException
	{
		return (MessageConnection)Connector.open(PREFIX+":"+port);		
	}

	protected void send(Connection conn, String message)
		throws IOException
	{
