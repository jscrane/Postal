...
final class WhiteMoveEntry extends MoveEntry
{
    protected String startSquare()
    {
        return "a1";
    }

    protected char up(char c)
    {
        return c == '8' ? '1' : ++c;
    }

    protected char down(char c)
    {
        return c == '1' ? '8' : --c;
    }

    protected char left(char c)
    {
        return c == 'a' ? 'h' : --c;
    }

    protected char right(char c)
    {
        return c == 'h' ? 'a' : ++c;
    }
}

final class BlackMoveEntry extends MoveEntry
{
    protected String startSquare()
    {
        return "h8";
